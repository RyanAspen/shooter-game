...
class PlayerEntity(MovingEntity):
    ...
    def __init__(self, spawn_point : point):
        ...
        hitboxes_normal = [
            pygame.Rect(0,0,size*3,size*3)
        ]
        frame_normal = PixelFrame(visual_rects = visual_rects_normal, hitboxes = hitboxes_normal)
        ...
        frame_right = PixelFrame(visual_rects = visual_rects_right, hitboxes = hitboxes_right)
        ...
        super().__init__(frame_dict, spawn_point, "Normal", "Player Entity", [0,0])
